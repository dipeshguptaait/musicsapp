...
function MusicPlayer() {
    return (
        <div className='musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3
         bg-[#232A4E] rounded-xl mt-5'>
            {/* upper part */}
            <div className='upperPart flex items-center justify-between '>
                <div className='profile flex'>
                    <img
                        src={require('../img/Mask Group_23.png')}
                        alt=''
            ...
            <div className='lowerPart flex items-center justify-between mt-5'>
                <div className='track flex justify-between text-5m text-gray-500 flex-[2] items-center'>
                    <span>2: 30</span>
                    <img
                        src={require("../img/Group_9.png")}
                        alt=''
                        className='w-[16rem]'
                    />
                    <span>4: 30</span>
